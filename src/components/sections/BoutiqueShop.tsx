          ...
          {product.price_type === "devis" ? (
            <>
              ...
              <Link href={`/contact?produit=${encodeURIComponent(product.name)}`}
                className="flex items-center gap-1.5 font-heading font-semibold px-4 py-2 rounded-xl text-sm transition-all hover:opacity-90"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            ...
            <div className="flex items-center gap-2 text-sm px-4 py-2.5 rounded-xl border border-border bg-white shadow-sm flex-shrink-0">
              <Truck size={15} style={{ color: "#2D5016", flexShrink: 0 }} />
        ...
        {/* Mobile filters */}
        <div className="md:hidden mb-5 flex items-center gap-2 flex-wrap">
          {categories.length > 0 && (
            <div className="flex flex-wrap gap-1 bg-white border border-border rounded-xl overflow-hidden shadow-sm">
