...
const PLACEHOLDER_TRANSFORMES: Product[] = [
  { id: "t1", name: "Gelée de Roses", description: "Gelée artisanale aux pétales de roses fraîches. Parfaite sur toast ou fromage.", category: "transforme", price: 12, stock: 24, image_url: null, season: null, active: true, created_at: "", updated_at: "" },
  { id: "t2", name: "Sirop de Lavande", description: "Sirop naturel de lavande québécoise. Idéal pour cocktails, limonades et desserts.", category: "transforme", price: 14, stock: 18, image_url: null, season: null, active: true, created_at: "", updated_at: "" },
  { id: "t3", name: "Bouquet Séché Naturel", description: "Bouquet de fleurs séchées naturellement, pour une décoration durable.", category: "transforme", price: 28, stock: 10, image_url: null, season: null, active: true, created_at: "", updated_at: "" },
  { id: "t4", name: "Vinaigre de Fleurs", description: "Vinaigre de cidre infusé aux fleurs sauvages. Pour salades et marinades.", category: "transforme", price: 11, stock: 20, image_url: null, season: null, active: true, created_at: "", updated_at: "" },
  { id: "t5", name: "Tisane de la Ferme", description: "Mélange de plantes séchées de notre jardin pour une tisane apaisante.", category: "transforme", price: 9, stock: 30, image_url: null, season: null, active: true, created_at: "", updated_at: "" },
];
    ...
    <section id="produits-transformes" className="section-padding relative" style={{ backgroundColor: "#FDF5EC", zIndex: 2 }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-7">
          {items.map((p) => <TransformedCard key={p.id} product={p} />)}
        </div>
      </div>
    </section>
  );
