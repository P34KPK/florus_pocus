...
const PLACEHOLDER_FLEURS: Product[] = [
  { id: "f1",  name: "Rose Rouge",          description: "Roses fraîchement coupées, parfum délicat.",                        category: "fleur",    price: 8.5, florist_price: null, stock: 50, image_url: null, season: "fleurs-fraiches",   active: true, created_at: "", updated_at: "" },
  { id: "f2",  name: "Tulipe Rose",          description: "Tulipes printanières, tiges longues et droites.",                  category: "fleur",    price: 6,   florist_price: null, stock: 30, image_url: null, season: "fleurs-fraiches",   active: true, created_at: "", updated_at: "" },
  { id: "f3",  name: "Tournesol",            description: "Grands tournesols lumineux qui égaient n'importe quel espace.",    category: "fleur",    price: 5.5, florist_price: null, stock: 40, image_url: null, season: "fleurs-fraiches",   active: true, created_at: "", updated_at: "" },
  { id: "f4",  name: "Confiture de Roses",   description: "Confiture artisanale aux pétales de roses.",                      category: "transforme", price: 9, florist_price: null, stock: 20, image_url: null, season: "comestibles",       active: true, created_at: "", updated_at: "" },
  { id: "f5",  name: "Zinnia Multicolore",   description: "Zinnias vibrants dans toutes les couleurs de l'arc-en-ciel.",     category: "fleur",    price: 4.5, florist_price: null, stock: 60, image_url: null, season: "fleurs-fraiches",   active: true, created_at: "", updated_at: "" },
  { id: "f6",  name: "Dahlia Bordeaux",      description: "Dahlias profonds aux pétales veloutés.",                          category: "fleur",    price: 7.5, florist_price: null, stock: 15, image_url: null, season: "fleurs-fraiches",   active: true, created_at: "", updated_at: "" },
  { id: "f7",  name: "Plant de Tomate Serre",description: "Plants de tomates cultivés en serre Inter-Ligna.",                category: "fleur",    price: 5,   florist_price: null, stock: 25, image_url: null, season: "serre-inter-ligna", active: true, created_at: "", updated_at: "" },
  { id: "f8",  name: "Lisianthus Blanc",     description: "Lisianthus élégants, ressemblent aux roses.",                     category: "fleur",    price: 8,   florist_price: null, stock: 18, image_url: null, season: "fleurs-fraiches",   active: true, created_at: "", updated_at: "" },
  { id: "f9",  name: "Tablier de Jardinage", description: "Tablier en coton épais, poche avant, style artisan.",             category: "transforme", price: 42, florist_price: null, stock: 10, image_url: null, season: "garde-robe",       active: true, created_at: "", updated_at: "" },
  { id: "f10", name: "Sirop de Lavande",     description: "Sirop de lavande artisanal, idéal en cocktail ou en dessert.",    category: "transforme", price: 12, florist_price: null, stock: 35, image_url: null, season: "comestibles",       active: true, created_at: "", updated_at: "" },
];
