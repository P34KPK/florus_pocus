  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-sm opacity-50 mt-1">Visites du site — données en temps réel</p>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {REPORTS.map((r) => (
            <button key={r.label} disabled
              className="flex items-center gap-3 p-4 rounded-xl border border-[#E0D5C8] text-left opacity-40 cursor-not-allowed">
