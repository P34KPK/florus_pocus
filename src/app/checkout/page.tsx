...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    ...
    async function loadSquare() {
      // Injecte le script manuellement pour éviter les problèmes avec Next.js Script + Turbopack
      if (!document.getElementById("square-sdk")) {
        ...
        // Script déjà dans le DOM — attendre que window.Square soit disponible
        let tries = 0;
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // 2. Créer la commande en DB via Server Action
    ...
    // 3. Charger la carte via l'API Square
      ...
      <main className="min-h-screen flex items-center justify-center px-4"
        ...
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-sm opacity-60 mb-2">
            Merci pour votre achat. Vous recevrez une confirmation par courriel.
          </p>
          {orderId && (
            <p className="text-xs opacity-40 mb-8 font-mono">
